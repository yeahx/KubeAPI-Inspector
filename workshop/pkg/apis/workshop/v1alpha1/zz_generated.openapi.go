...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"workshop/pkg/apis/workshop/v1alpha1.Cluster":                    schema_pkg_apis_workshop_v1alpha1_Cluster(ref),
		"workshop/pkg/apis/workshop/v1alpha1.ClusterList":                schema_pkg_apis_workshop_v1alpha1_ClusterList(ref),
		"workshop/pkg/apis/workshop/v1alpha1.ClusterSpec":                schema_pkg_apis_workshop_v1alpha1_ClusterSpec(ref),
		"workshop/pkg/apis/workshop/v1alpha1.ClusterStatus":              schema_pkg_apis_workshop_v1alpha1_ClusterStatus(ref),
	}
}
...
func schema_pkg_apis_workshop_v1alpha1_Cluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("workshop/pkg/apis/workshop/v1alpha1.ClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("workshop/pkg/apis/workshop/v1alpha1.ClusterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "workshop/pkg/apis/workshop/v1alpha1.ClusterSpec", "workshop/pkg/apis/workshop/v1alpha1.ClusterStatus"},
	}
}

func schema_pkg_apis_workshop_v1alpha1_ClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("workshop/pkg/apis/workshop/v1alpha1.Cluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "workshop/pkg/apis/workshop/v1alpha1.Cluster"},
	}
}

func schema_pkg_apis_workshop_v1alpha1_ClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_workshop_v1alpha1_ClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
